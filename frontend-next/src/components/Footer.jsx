    ...
    <footer className="bg-white shadow-sm mt-auto py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <p className="text-gray-500 text-sm">
              &copy; {new Date().getFullYear()} Claude ROI Calculator. Open
              source project by{" "}
              <a
        ...
        <div className="mt-4 text-center text-xs text-gray-400">
          <span className="font-serif text-coral-500">Claude</span> is a
          trademark of Anthropic. This tool is not officially affiliated with
          Anthropic.
        </div>
      </div>
    </footer>
